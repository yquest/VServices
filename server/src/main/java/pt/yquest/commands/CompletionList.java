...
class CompletionList implements Handler<AsyncResult<List<String>>>, AsyncResult<List<String>> {
    private static final Logger LOGGER = LoggerFactory.getLogger(CompletionList.class);
    private final int order;
    private final Completion completion;
    private final Future<List<String>> future = Promise.<List<String>>promise().future();
